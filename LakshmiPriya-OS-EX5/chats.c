...
// handler function to print message received from client 

void handler(int signum) 
{ 
	// if signum is SIGUSR1, then server is receiving a message from client 
...
{ 
	...
	// calling the signal function using signal type SIGserver 
